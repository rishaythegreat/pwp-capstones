...
class Book(object):
    ...
    def add_rating(self, rating):
        if rating is not None and rating >= ) and rating <= 4:
...
class TomeRater(object):
    ...
    def create_non_firction(self, title, subject, level, isbn):
    ...
    def add_user(self, name, email, user_books=Noone):
